...
class CloseDialog extends JDialog {
...
enum U07_AFG02_ShapeType {
    CIRCLE, SQUARE, TRIANGLE
}

abstract class U07_AFG02_MenuAdapter implements MenuListener {
    @Override
...
class U07_AFG02_Model {
    private int shapePosX, shapePosY, shapeSize, frameWidth, frameHeight;
    private Color shapeColor = Color.RED;
    private U07_AFG02_ShapeType activeShape = U07_AFG02_ShapeType.CIRCLE;

    U07_AFG02_Model(int frameWidth, int frameHeight, int shapeSize) {
    ...
    public U07_AFG02_ShapeType getActiveShape() {
        return activeShape;
    }

    public void setActiveShape(U07_AFG02_ShapeType shape) {
...
class U07_AFG02_View extends JComponent {
    private U07_AFG02_Model m_Model;

    U07_AFG02_View(U07_AFG02_Model model) {
        this.m_Model = model;
    }
...
class U07_AFG02_Controller {
    private U07_AFG02_Model m_Model;
    private U07_AFG02_View m_View;
    ...
    U07_AFG02_Controller() {
        m_Model = new U07_AFG02_Model(600, 400, 50);
        m_View = new U07_AFG02_View(m_Model);
        initFrame();
        createMenuBar();
    ...
    private void showShapeSelectionDialog() {
        ...
        circleButton.addActionListener(e -> {
            m_Model.setActiveShape(U07_AFG02_ShapeType.CIRCLE);
            dialog.dispose();
        });
        ...
        squareButton.addActionListener(e -> {
            m_Model.setActiveShape(U07_AFG02_ShapeType.SQUARE);
            dialog.dispose();
        });
        ...
        triangleButton.addActionListener(e -> {
            m_Model.setActiveShape(U07_AFG02_ShapeType.TRIANGLE);
            dialog.dispose();
        });
