// Aufgabe 2: Implementieren Sie den "Schließen" Button für Ihre Fenster
package uebung;
import java.awt.*;
import javax.swing.*;
import java.awt.event.*;
import java.util.Scanner;
class U04_AFG02_Model{
    public int sizeX, sizeY, m, n, space = 2;
    U04_AFG02_Model(int sizeX, int sizeY, int m, int n){
        this.sizeX = sizeX; this.sizeY = sizeY; this.m = m; this.n = n;
    }
}
class U04_AFG02_View extends JComponent{
    private U04_AFG02_Model m_Model;
    U04_AFG02_View(U04_AFG02_Model model){
        this.m_Model = model;
        this.setOpaque(true);
...
class U04_AFG02_Controller{
    private U04_AFG02_Model m_Model;
    private U04_AFG02_View m_View;
    private JFrame frame = new JFrame();
    private ImageIcon  icon;
    private JButton closeButton;
    U04_AFG02_Controller(){
        Scanner sc = new Scanner(System.in);
        System.out.println("Erst Fenstergröße, dann Anzahl Rechtecke + Zeile: ");
        m_Model = new U04_AFG02_Model(sc.nextInt(), sc.nextInt(), sc.nextInt(), sc.nextInt());
        m_View = new U04_AFG02_View(m_Model);
